...
public class CreditDetails extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.creditdetails);
	...
	public void onClick(View v) {
		...
		Keeprecord rd2=new Keeprecord(this);
		rd2.open();
		rd2.deleteEntry(lr);
		rd2.close();
			}
